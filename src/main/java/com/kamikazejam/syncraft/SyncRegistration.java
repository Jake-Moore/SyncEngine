...
//  devs should be able to obtain this object from SyncraftAPI
...
public class SyncRegistration {
     ...
     * This includes the payload group prefix, described in {@link SyncraftAPI#getFullDatabaseName(String)} (String)}
     * All plugin caches will be stored in this database as collections
     */
    private final String databaseName;

    // package-private because Syncraft is the only one allowed to create this
