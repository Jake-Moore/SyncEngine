...
public class ServerPublisher {
    ...
    private final SyncEnginePlugin plugin;
    ...
    public void publishPing(@NotNull String dbName) {
        @Nullable RedisService redisService = plugin.getRedisService();
    ...
    public void publishQuit(@NotNull String dbName, boolean callIsSync) {
        ...
        plugin.getLogger().info("Publishing QUIT event for server " + serverService.getThisServer().getName());
